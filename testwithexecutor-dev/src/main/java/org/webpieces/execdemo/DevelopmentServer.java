...
import org.webpieces.execdemo.basesvr.YourCompanyServer;
import org.webpieces.execdemo.services.DevConfig;
import org.webpieces.execdemo.services.DevServerUtil;
import org.webpieces.execdemo.services.YourCompanyDevelopmentServer;
...
public class DevelopmentServer extends YourCompanyDevelopmentServer {
	...
	public DevelopmentServer(boolean usePortZero) {
		super("testwithexecutor", usePortZero);
	}
