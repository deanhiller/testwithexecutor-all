package org.webpieces.execdemo.base;
...
import org.webpieces.execdemo.basesvr.YourGlobalModule;
import org.webpieces.execdemo.json.*;
import org.webpieces.execdemo.web.login.LoginRoutes;
import org.webpieces.execdemo.web.main.MainRoutes;
import org.webpieces.execdemo.web.secure.crud.CrudRoutes;
import org.webpieces.execdemo.web.secure.crudajax.AjaxCrudRoutes;
...
public class ProdServerMeta implements WebAppMeta {
    ...
    public List<Routes> getRouteModules() {
		return Lists.newArrayList(
				...
				new MainRoutes(),
				//The Controller package regex is org.webpieces.execdemo.web.secure\..* so that we match org.webpieces.execdemo.web.secure.* Controllers 
				new LoginRoutes("/org/webpieces/execdemo/web/login/AppLoginController", "org.webpieces.execdemo.web.secure\\..*", "password"),
				new CrudRoutes(),
				new AjaxCrudRoutes(),
				new JsonRoutes()
				);
	...
	public List<Plugin> getPlugins() {
		...
		return Lists.newArrayList(
				...
				new JacksonPlugin(new JacksonConfig().setPackageFilterPattern("org.webpieces.execdemo.json.*")),
